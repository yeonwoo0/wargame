...
<head>
    ...
    <title>SQL Injection - Level 7</title>
    <style>
        .login-container {
            display: flex;
...
<body>
    <div class="alert alert-dark" role="alert" style="text-align: center; width:50%; margin:auto; margin-top:200px">
        <strong>Let's Bypass login authentication</strong>
    </div>
    ...
    <div style="margin: auto; text-align:center">
        <button type="button" class="btn btn-outline-danger" onclick="location.href='../code/lev6.php?schema=&table='">Prev</button>
