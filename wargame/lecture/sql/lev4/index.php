<?php
    ...
    if ($num == 0){
        echo "<script>alert('Non-existent post');history.back(-1)</script>";
        exit;
    }
...
<head>
    ...
    <title>SQL Injection - Level 10</title>
    <style>
        .main-container{
            width: 50%;
            height: 200px;
...
<body>
    ...
    <div class="alert alert-dark" role="alert" style="text-align: center;">
        ...
        <div style="margin-top: 10px;">
            <button type="button" class="btn btn-outline-danger" onclick="location.href='../lev3/index.php'">Prev</button>
            <button type="button" class="btn btn-outline-danger" onclick="location.href='../../../index.php'">Home</button>
            <button type="button" class="btn btn-outline-danger" onclick="location.href='../lev5/index.php'">Next</button>
        </div>
    </div>
    </div>
</body>
