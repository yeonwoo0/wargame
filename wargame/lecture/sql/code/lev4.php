...
$idx = isset($_GET['idx']) ? trim($_GET['idx']) : 2;
if (preg_match('/["\']/i', $idx)) {
...
<head>
    ...
    <title>SQL Injection - Level 4</title>
...
<body>
    ...
    <div style="margin: auto; text-align:center; margin-top:10px">
        <button type="button" class="btn btn-outline-danger" onclick="location.href='./lev3.php?idx=2'">Prev</button>
        <button type="button" class="btn btn-outline-danger" onclick="location.href='../../../index.php'">Home</button>
        <button type="button" class="btn btn-outline-danger" onclick="location.href='./lev5.php?schema='">Next</button>
    </div>
</body>
</html>