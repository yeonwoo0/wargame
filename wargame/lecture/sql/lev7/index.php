...
<head>
    ...
    <title>SQL Injection - Level 13</title>
    <style>
        .main-container{
            width: 50%;
            height: 200px;
...
<body>
    ...
    <div class="alert alert-dark" role="alert" style="text-align: center; width:100%; margin:auto;">
        <strong>Let's get column name of database !</strong>
    </div>
